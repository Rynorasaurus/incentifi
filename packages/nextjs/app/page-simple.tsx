        ...
        <div className="px-5">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-base-content/70">
              Gamified Chore dApp - Complete tasks, earn NFTs, claim rewards!
            </p>
          </div>
            ...
            <div className="text-center">
              <div className="bg-base-200 p-8 rounded-2xl shadow-lg border border-base-300 max-w-md mx-auto">
                ...
                <p className="text-base-content/70 mb-4">
                  Connect your wallet to start earning rewards by completing chores!
                </p>
              </div>
            </div>
          ) : (
              ...
              <div className="bg-base-100 p-6 rounded-2xl shadow-lg border border-base-300">
                    ...
                    >
                      {chores.map((chore, index) => (
                        <option key={index} value={index}>
                          {chore.name} - {chore.reward} ETH - {chore.timeLimit}h
                        </option>
                      ))}
                    </select>
                  </div>
                ...
                <div className="bg-base-200 p-4 rounded-xl">
                  ...
                  <div className="flex gap-4 text-sm">
                    <span className="badge badge-success">💰 {chores[selectedChore].reward} ETH</span>
                  ...
                  {chores.map((chore, index) => (
                    <div key={index} className="bg-base-200 p-4 rounded-xl">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="badge badge-success text-xs">💰 {chore.reward} ETH</span>
              ...
              <div className="bg-base-100 p-6 rounded-2xl shadow-lg border border-base-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-base-content/70">Burn your NFT for ETH rewards + achievement badge</p>
                  </div>
                </div>
              </div>
            </div>
